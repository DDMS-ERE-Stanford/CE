###########################################################
## intitial.py: generate intial realizations for CE algorithm 
###########################################################
...
## read from data file for initials generated by multipoint geostatistics
...
## generate initial using SVM classifer and observed static data 
...
## generate initial using Gaussian process (kriging) 
